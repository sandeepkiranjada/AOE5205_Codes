function f = ffunctgravgradsc03(x,u,IMoIbody,norbit)
%
...
%    R = R(q)
%
%  This function has been created by modifying ffunctgravgradsc02.m
%  in order to remove the t input and add the new u input.
%  
%
%  Inputs:
%
...
%                          IMoIbody is defined.  
%
%    u                     = [Tb1;Tb2;Tb3], the 3-by-1 control input
%                          vector that gives the net applied torque
%                          in addition to gravity-gradient torque
%                          in body-axis coordinates, in N-m units.
%
...
%
   Omegamat = ...
    [                  0,  deltaomegavec(3,1), -deltaomegavec(2,1), ...
                               deltaomegavec(1,1);...
     -deltaomegavec(3,1),                   0,  deltaomegavec(1,1), ...
                               deltaomegavec(2,1);...
      deltaomegavec(2,1), -deltaomegavec(1,1),                   0, ...
                               deltaomegavec(3,1);...
     -deltaomegavec(1,1), -deltaomegavec(2,1), -deltaomegavec(3,1), ...
                                                0];
   qdot = 0.5*Omegamat*q;
%
...
%
   ...
   omegavecdot = IMoIbody\(-cross(omegavec,hvec) + Tgravgradvec + u);
%
