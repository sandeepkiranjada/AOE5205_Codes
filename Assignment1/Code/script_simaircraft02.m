...
%
   ...
   title('Ground Track for simaircraft02.mat')
%
...
%
   ...
   grid
   ylabel('Altitude (m)')
   title('State time histories for simaircraft02.mat')
   subplot(412)
   hold off
   plot(thist,xhist(:,4))
   grid
...
%
   ...
   grid
   ylabel('Thrust (N)')
   title('Control input time histories for simaircraft02.mat')
   subplot(312)
   hold off
...
%
   textcommands = ['These data have been generated by the',...
                   ' commands in script_simaircraft02.m'];
   save simaircraft02 