...
%
   ...
   title('Ground Tracks for simaircraft03.mat')
...
%
   ...
   title('State time histories for simaircraft03.mat')
   legend('Without Centrifugal & Coriolis Effects',...
          'With Centrifugal & Coriolis Effects')
   subplot(412)
   hold off
...
%
   ...
   grid
   ylabel('Thrust (N)')
   title('Control input time histories for simaircraft03.mat')
   subplot(312)
   hold off
...
%
   textcommands = ['These data have been generated by the',...
                   ' commands in script_simaircraft03.m'];
   save simaircraft03 